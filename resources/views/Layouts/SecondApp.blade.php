...
<body style="background-color: #fffbfb">
    <header>
      <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-dark SecondMenu bg-primary">
              ...
              <div class="collapse navbar-collapse">
                  <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                      <li class="nav-item">
                          ...
                          <div class="linea" style="background-color: #645948;"></div>
                      </li>
                      <li class="nav-item">
    ...
    <div class="social">
      <ul>
        ...
        <li><a href="https://api.whatsapp.com/send?phone=50589326686&text=Estoy+interesado+en+estudiar+en+modalidad+virtual" target="_blank" class="icon-whatsapp"></a></li>
